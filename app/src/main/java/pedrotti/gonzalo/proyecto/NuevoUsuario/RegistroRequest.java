...
//  private static  final String ruta = "https://192.168.0.13:/v1/registrar.php";
    ...
    public RegistroRequest(String nombreUsuario, String apellidoUsuario, String correoUsuario, int telefonoUsuario, String contrasenaUsuario, Response.Listener<String> listener){
